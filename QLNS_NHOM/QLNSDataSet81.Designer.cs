...
namespace QLNS_NHOM {
    ...
    public partial class QLNSDataSet8 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/QLNSDataSet81.xsd";
        ...
        public partial class NHANVIENDataTable : global::System.Data.TypedTableBase<NHANVIENRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public NHANVIENRow AddNHANVIENRow(int manv, string hoten, string sdt) {
    ...
    public partial class NHANVIENTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[NHANVIEN] WHERE (([manv] = @Original_manv) AND ((@IsNull_hoten" +
                " = 1 AND [hoten] IS NULL) OR ([hoten] = @Original_hoten)) AND ((@IsNull_sdt = 1 " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[NHANVIEN] ([manv], [hoten], [sdt]) VALUES (@manv, @hoten, @sdt" +
                ");\r\nSELECT manv, hoten, sdt FROM NHANVIEN WHERE (manv = @manv)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NHANVIEN] SET [manv] = @manv, [hoten] = @hoten, [sdt] = @sdt WHERE (([manv] = @Original_manv) AND ((@IsNull_hoten = 1 AND [hoten] IS NULL) OR ([hoten] = @Original_hoten)) AND ((@IsNull_sdt = 1 AND [sdt] IS NULL) OR ([sdt] = @Original_sdt)));
SELECT manv, hoten, sdt FROM NHANVIEN WHERE (manv = @manv)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT manv, hoten, sdt FROM dbo.NHANVIEN";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        public virtual int Delete(int Original_manv, string Original_hoten, string Original_sdt) {
        ...
        public virtual int Insert(int manv, string hoten, string sdt) {
        ...
        public virtual int Update(int manv, string hoten, string sdt, int Original_manv, string Original_hoten, string Original_sdt) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string hoten, string sdt, int Original_manv, string Original_hoten, string Original_sdt) {
            return this.Update(Original_manv, hoten, sdt, Original_manv, Original_hoten, Original_sdt);
        }
    }
